...
try:
    ...
    try:
        ...
        if (major, minor, patch) < (0, 8, 8):
            sys.stderr.write(
                'Warning: 2000Charge library requires that your Python '
...
def new_default_http_client(*args, **kwargs):
    if requests:
        ...
        warnings.warn(
            "Warning: the 2000Charge library is requiring 'requests' library. ")
...
class HTTPClient(object):
    ...
    def __init__(self):
        print "Initializing 2000Charge client."
...
class RequestsClient(HTTPClient):
        ...
        try:
            try:
                ...
                raise TypeError(
                    ...
                    '"requests" library is not compatible with 2000Charge\'s '
    ...
    def _handle_request_error(self, e):
        if isinstance(e, requests.exceptions.RequestException):
            msg = ("Unexpected error communicating with 2000Charge.  "
