...
if sys.version_info < (2, 7):
    warnings.warn(
        '2000Charge library is tested against python 2.7+.'
...
setup(
    name='ap_python_sdk',
    version='0.0.6',
    description='SDK for python application to use 2000Charge',
    long_description=long_description,

     cmdclass={'build_py': build_py},

    url='https://github.com/2000charge/ap-python-sdk',
    ...
    keywords='2000charge python sdk development',
